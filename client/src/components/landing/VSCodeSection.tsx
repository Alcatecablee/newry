      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Experience NeuroLint directly in Visual Studio Code with real-time analysis, 
            instant fixes, and seamless integration into your development workflow.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-1">
            <div className="bg-gray-900/90 border border-gray-700 rounded-2xl overflow-hidden shadow-2xl">
              ...
              <div className="bg-gray-800 px-4 py-3 flex items-center gap-2 border-b border-gray-700">
                ...
                <div className="text-sm text-gray-300 ml-4">Header.tsx - NeuroLint</div>
              </div>
              
              {/* VS Code Interface */}
              <div className="p-6">
                <div className="font-mono text-sm space-y-2">
                  <div className="text-gray-500">1  import React from 'react';</div>
                  <div className="text-gray-500">2  </div>
                  <div className="text-gray-500">3  export function Header() &#123;</div>
                  <div className="text-gray-500">4    const items = ['Home', 'About', 'Contact'];</div>
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-300 ml-4">&#123;items.map(item =&gt;</span>
                ...
                <div className="mt-4 bg-gray-800 border border-gray-600 rounded-lg p-4 max-w-sm">
                  <div className="text-sm font-medium text-white mb-2">NeuroLint Quick Fix</div>
          ...
          <div className="order-2 lg:order-2 space-y-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2 text-white">Real-time Diagnostics</h3>
                <p className="text-gray-400">
                  See issues highlighted instantly as you type with intelligent error detection and warnings.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2 text-white">Smart Quick Fixes</h3>
                <p className="text-gray-400">
                  One-click solutions for common issues with intelligent code transformations and best practices.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2 text-white">Workspace Analysis</h3>
                <p className="text-gray-400">
                  Analyze entire projects with comprehensive reporting and batch transformations.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2 text-white">Customizable Layers</h3>
                <p className="text-gray-400">
                  Configure which analysis layers to run and customize rules to match your coding standards.
                </p>
              </div>
            </div>
          </div>
